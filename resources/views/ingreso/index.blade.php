@extends('layouts.admin')
	...
	<div class="medilife-tabs-content">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="specialities-tab" data-toggle="tab" href="#specialities" role="tab" aria-controls="specialities" aria-selected="true">Ingresos</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade show active" id="specialities" role="tabpanel" aria-labelledby="specialities-tab">
                                <div class="medilife-tab-content d-md-flex align-items-center">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                        <h2>Lista de todos los ingresos</h2>
		<section class="content">
	        <div class="box box-solid">
	            <div class="box-body">
	                <div class="row">
	                    <div class="col-md-8">
	                        <a href="ingreso/create" class="btn btn-primary btn-flat" title="Agregar nuevo ingreso"><span class="fa fa-plus"></span> Agregar</a>
	                    </div>
		...
		$(function(){
			...
			$("#myTable").DataTable({
				...
				"columns":[
					...
					{"orderable": false,
				          render:function(data, type, row){
				              return '<button data-toggle="modal" data-target="#modal-default" class="btn btn-info btn-xs btn-dato" title="Ver datos completos" value="'+row.idingreso+'"><span class="fa fa-search"></span> </button>';
				          }
				     }
				]
			});
