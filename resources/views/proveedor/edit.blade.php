		...
		<section class="content">
	        <div class="box box-solid">
	            <div class="box-body">
	                <div class="row">
	                    <div class="col-md-8">
							<div class="box-header with-border">
								<h4 class="box-title"><span class="glyphicon glyphicon-list-alt"></span> Actualizar proveedor </h4>
							</div>
					...
					<br>
					{!!Form::model($proveedor,['method'=>'PATCH','route'=>['proveedor.update',$proveedor->idproveedor],'id'=>'frm_add'])!!}
						...
						<div class=" form-add-body">
							...
							<div class="form-group">
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									...
									<input type="text" class="form-control" name="nit" id="nit" placeholder="Introduce nit" maxlength="11" value="{{$proveedor->nit}}">
									<input type="hidden" class="form-control" id="onit" value="{{$proveedor->nit}}">
								</div>
								</div>
							</div>
						</div>
