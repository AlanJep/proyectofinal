@extends('layouts.admin')
		...
		<section class="content">
	        <div class="box box-solid">
	            <div class="box-body">
	                <div class="row">
	                    <div class="col-md-8">
	                        <a href="proveedor/create" class="btn btn-primary btn-flat" title="Agregar nuevo proveedor"><span class="fa fa-plus"></span> Agregar</a>
	                    </div>
	                    <div class="col-md-4" align="right">
				        	<ol class="breadcrumb">
					            <li><a href="{{url('inicio')}}" class="act" title="Ir a inicio"><i class="fa fa-home"></i> Inicio /</a></li>
					            <li class="menu-active">Proveedores</li>
					        </ol>
			        	</div>
	                </div>
	                <hr>
		      ...
		      <div class="modal-dialog">
		        <div class="modal-content">
		          <div class="modal-header modal-title">
		            <h4 class="modal-title"><span class="fa fa-info-circle"></span> Informacion del Proveedor</h4>
	...
	<script>
					...
					{"orderable": false,
				          ...
				          @if(Auth::user()->rol=="Administrador")
				          	if(row.estado=="Activo"){
				              	op=' <a href="proveedor/estado/'+row.idproveedor+'" class="btn btn-success btn-xs" title="Dar Baja">'+
				              				'<span class="fa fa-check"></span></a>';
				             }
				             else{
				          		op=' <a href="proveedor/estado/'+row.idproveedor+'" class="btn btn-danger btn-xs" title="Dar Alta">'+
				              				'<span class="fa fa-warning"></span></a>';
				              			
				              			
				          	}
				          @endif
				          	opc=' <a href="proveedor/editar/'+row.idproveedor+'" class="btn btn-warning btn-xs" title="Editar">'+
				              				'<span class="fa fa-pencil"></span></a> '+
				              	 ' <button data-toggle="modal" data-target="#modal-default" class="btn btn-info btn-xs btn-dato" title="Ver datos completos" value="'+row.idproveedor+'"><span class="fa fa-search"></span> </button>';
	    ...
	    $(document).on("click",".btn-dato",function(e){
			  var url="proveedor/verproveedor/"+$(this).val();
			  $.ajax({
			    url:url,
			    type:"GET",
