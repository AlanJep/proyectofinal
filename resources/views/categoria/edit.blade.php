...
<div class="medilife-tabs-content">
		...
		<section class="content">
	        <div class="box box-solid">
	            <div class="box-body">
	                <div class="row">
	                    <div class="col-md-8">
							<div class="box-header with-border">
								<h4 class="box-title"><span class="glyphicon glyphicon-list-alt"></span> Actualizar Categoria </h4>
							</div>
					...
					{!!Form::model($categoria,['method'=>'PATCH','route'=>['categoria.update',$categoria->id],'id'=>'frm_add'])!!}
						<div class=" form-add-body">
							<div class="form-group">
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<label for="categoria"><span class="fa fa-list-alt"></span> Categoria (*)</label>
										<input type="text" class="form-control" id="categoria" name="categoria" placeholder="Introduce categoria" value="{{$categoria->nombre}}" >
									</div>
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<label for="descripcion"><span class="fa fa-list"></span> Descripcion</label>
										<textarea class="form-control" name="descripcion" id="descripcion" placeholder="Introduce descripcion de la categoria, hasta 100 caracteres"> {{$categoria->descri}} </textarea>
									</div>
								</div>
							</div>
						</div>
		...
		@push ('scripts')
			<script>
			    ...
			    cat=$("#categoria").val();
			    if(cat=="Instrumentos" || cat=="Medicamentos" || cat=="Insumos" ){
